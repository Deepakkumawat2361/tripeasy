(function ($) {
  ...
  var modelApp = {
    ...
    menu: function () {
      ...
      var $slimeScrollSelector = $(
        ".mb-navigation .menu-wrapper, .author-area-content"
      );
    ...
    slider_style_two: function () {
      ...
      $mainSliderTwo.each(function () {
        ...
        typeof $sliderItemsMargin !== "undefined"
          ? $sliderItemsMargin
          : ($sliderItemsMargin = 30);
        $self.owlCarousel({
          loop: true,
          ...
          responsive: {
            ...
            1200: {
              items: typeof $sliderItems !== "undefined" ? $sliderItems[0] : 2,
            },
          },
        });
        $self.each(function () {
          var $this = $(this),
            $next_element = $this
              .prevAll()
              .find(".block-navigation-area .item-navigation  .next-item"),
            $previous_element = $this
              .prevAll()
              .find(".block-navigation-area .item-navigation .previous-item");
    ...
    searchOverlay: function () {
      ...
      $(document).on("click", function (e) {
        ...
        if (
          !$authorSelectorDoc.is(e.target) &&
          $authorSelectorDoc.has(e.target).length === 0
        ) {
    ...
    mobileTab: function () {
      ...
      $tabli.each(function (e, value) {
        var $select = $(
          "<option value='" + e + "'>" + $(this).text() + "</option>"
        );
      ...
      $responsiveNav.on("change", function (e) {
        ...
        if ($.isNumeric(url) === true) {
          var $navSlector = $(
            ".vehicle-filter-area li a, .post-filter-area li a"
          );
