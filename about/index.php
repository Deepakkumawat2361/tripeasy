...
$header = file_get_contents($path . "/tripeasy/layouts/header.html");
$footer = file_get_contents($path . "/tripeasy/layouts/footer.html");
$glinks = file_get_contents($path . "/tripeasy/layouts/global-links.html");
$gscripts = file_get_contents($path . "/tripeasy/layouts/global-scripts.html");
