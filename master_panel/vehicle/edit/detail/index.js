	...
	getlist();
				...
				success: function(result){
				  data = result.response;
					...
					if(data.status == 'success'){
					   window.location.href = '/tripeasy/master_panel/vehicle/edit/document/?id='+id; 
					}
							...
							imageHTML += `
							         <div class="col-md-4">
							           <div class="form-group p-4 bg-border-gray-light d-sm-flex justify-content-between    align-items-center rounded-10">
										...
										<a data-img="${array[k]}" class="btn btn-danger bg-opacity-10 text-white fw-bold fw-semibold delete">Delete</a>
                    ...
                    imageHTML += `
					        <div class="col-md-4">
							  <div class="form-group p-4 bg-border-gray-light d-sm-flex justify-content-between    align-items-center rounded-10">
											...
											<div class="d-flex ms-sm-3 ms-md-0">
												<a  data-img="${array[j]}" class="btn bg-danger bg-opacity-10 text-danger fw-semibold delete">Delete</a>
		...
		$(document).on("click",".delete", function(){
			...
			var  img = $(this).attr("data-img");
			 $.ajax({
				url: '/tripeasy/api/v1/admin/cars/delete_img.php?id='+id,
				method: 'POST',
				dataType: 'json',
				data: {img},
				processData: false,
